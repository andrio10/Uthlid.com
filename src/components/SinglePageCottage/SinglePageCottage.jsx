...
function SinglePageCottage(props) {
  const [Information, setInformation] = useState(CottageInfoOjbect[props.match.params.id.toLowerCase()]);
  ...
  return (
    <Container>
      <Header {...Information} /> {/* Sendi niður upplýsingarnar í gegnum props. */}
      <BlackbarInformation {...Information} />
